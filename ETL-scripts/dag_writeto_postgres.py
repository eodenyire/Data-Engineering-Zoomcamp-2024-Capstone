...
# Define DAG
dag = DAG(
    'parquet_to_postgresql',
    default_args=default_args,
    description='A DAG to pull, process, and write parquet files to PostgresSQL',
...
write_to_postgresql = BashOperator(
    task_id='write_to_postgresql',
    bash_command='your_script_to_write_to_postgresql.sh',
    dag=dag,
)

# Define task dependencies
pull_parquet_files >> process_parquet_files >> write_to_postgresql
